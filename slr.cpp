...
void Slr::calClosure(vector<P_Item> &_items, set<string> &rule_name_set, const vector<P_Rule> &ruleList,
...
void Slr::refreshEndForSymbolFlow(vector<vector<P_Item>>  &items_list_temp) {
	bool isChange = true;
